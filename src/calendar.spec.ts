...
describe('defaultMonthData()', () => {
  ...
  property('generates first day with key 1', integer(2000, 2100), integer(1, 12),
    (year, month) => Object.keys(defaultMonthData(year, month))[0] === '1'
  )

  property('generates incremental keys', integer(2000, 2100), integer(1, 12),
    (year, month) => {
  ...
  property('starts the AM period at 9:00', integer(2000, 2100), integer(1, 12),
    (year, month) => all(
      ([h, m]) => h === 9 && m === 0,
  ...
  property('ends the AM period at 13:00', integer(2000, 2100), integer(1, 12),
    (year, month) => all(
      ([h, m]) => h === 13 && m === 0,
  ...
  property('starts the PM period at 14:00', integer(2000, 2100), integer(1, 12),
    (year, month) => all(
      ([h, m]) => h === 14 && m === 0,
  ...
  property('ends the PM period at 17:30', integer(2000, 2100), integer(1, 12),
    (year, month) => all(
      ([h, m]) => h === 17 && m === 30,
