...
describe('Month', () => {
  ...
  it('renders month name and year', () => {
    const { getByText } = render(<Month name={SIGNATURE} month={12} year={2012} />)
  ...
  describe('renders two labels (morning and afternoon) for every day in the month', () => {
    it('renders 31 morning labels for August 2018', () => {
      const { getAllByLabelText } = render(<Month name={SIGNATURE} month={8} year={2018} />)
    ...
    it('renders 30 morning labels for September 2018', () => {
      const { getAllByLabelText } = render(<Month name={SIGNATURE} month={9} year={2018} />)
    ...
    it('renders 28 morning labels for February 2019', () => {
      const { getAllByLabelText } = render(<Month name={SIGNATURE} month={2} year={2019} />)
    ...
    it('renders 29 morning labels for February 2020', () => {
      const { getAllByLabelText } = render(<Month name={SIGNATURE} month={2} year={2020} />)
  ...
  it('clears signature when checkbox is unchecked', () => {
    ...
    const { getByLabelText } = render(<Month name={SIGNATURE} month={8} year={2018} />)
